            ...
            <section id="features" class="features">
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <header class="section-header">
                        <p>Dodaj notatkę uczniowi ${currentStudent.name}</p>
                    </header>

                    <div class="container">

                        <form:form class="padding-small text-center" method="post" modelAttribute="note">
                            <h1 class="text-color-darker">Tworzenie nowego ucznia</h1>
                            <div class="form-group">
                                <form:textarea class="form-control" path="comment" placeholder="Napisz komentarz"/>
                                <form:select path="grade">
                                    <form:option value="0" label="Wybierz oscenę"/>
